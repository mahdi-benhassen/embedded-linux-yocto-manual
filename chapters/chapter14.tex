 ...
 Use linux-yocto or vendor kernel recipes to build and deploy the kernel and device trees. Configure KERNEL_FEATURES and fragments to control options and patches.
 \section{BSP Layers}
