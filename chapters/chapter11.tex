...
A recipe declares metadata including description, license, \texttt{SRC\_URI} for fetching sources, and tasks like \texttt{do\_compile} and \texttt{do\_install}. Variables control build flags and dependencies.
 ...
 \section{Packaging}
Enable packaging into rpm, deb, or ipk and ensure the \texttt{do\_package} task creates correct file lists and dependencies.
